  ...
  $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}),
      ...
      $.fn.jqGrid = function(a) {
        ...
        return this.each(function() {
          if (!this.grid) {
            ...
            var j, k = $.jgrid.getMethod("getStyleUI"), l = d.p.styleUI + ".common", m = k(l, "disabled", !0), n = k(l, "highlight", !0), o = k(l, "hover", !0), p = k(l, "cornerall", !0), q = k(l, "icon_base", !0), r = $.jgrid.styleUI[d.p.styleUI || "jQueryUI"].colmenu, s = $.jgrid.msie(), t = [], u = [], v = [];
            l = d.p.styleUI + ".base",
            ...
            var x, y = ["shiftKey", "altKey", "ctrlKey"], z = function(a, b) {
              ...
              if ("local" === m.datatype && p.repeatitems === !0)
                for (j = H(s),
                         k = G("local"),
                         e = m.keyName === !1 ? $.isFunction(p.id) ? p.id.call(d, n) : p.id : m.keyName,
                         a = 0; o > a; a++) {
                  for (c = n[a],
              ...
              if (g && (d.p.data = [],
                      ...
                      d.p.reccount = 0,
                      $.isXMLDoc(a)) {
                -1 !== d.p.treeANode || d.p.scroll ? b = b > 1 ? b : 1 : (I.call(d, !1, !0),
                        b = 1);
                var m, n, o, p, q, r, s, t, u, v = $(d), w = 0, x = d.p.multiselect === !0 ? 1 : 0, y = 0, A = d.p.rownumbers === !0 ? 1 : 0, B = [], C = {}, J = [], K = k(l, "rowBox", !0, "jqgrow ui-row-" + d.p.direction);
                d.p.subGrid === !0 && (y = 1,
                ...
                M || (M = []);
                var N, O = M.length, P = 0, Q = [], R = parseInt(d.p.rowNum, 10), S = d.p.scroll ? $.jgrid.randId() : 1, T = $(d).find("tbody:first"), U = !1;
                if (d.p.grouping && (U = d.p.groupingView.groupCollapse === !0,
                        N = $.jgrid.getMethod("groupingPrepare")),
                    O > 0 && d.p.page <= 0 && (d.p.page = 1),
                    M && O) {
                  e && (R *= e + 1);
                  for (var V = $.isFunction(d.p.afterInsertRow), W = A ? k(l, "rownumBox", !1, "jqgrid-rownum") : "", X = x ? k(l, "multiBox", !1, "cbox") : ""; O > P; ) {
                    t = M[P],
                        u = r(t, S + P),
                        u = d.p.idPrefix + u;
                    var Y = J.length;
                    if (J.push(""),
                        A && J.push(F(0, P, d.p.page, d.p.rowNum, W)),
                        x && J.push(E(u, A, P, !1, X)),
                        y && J.push(p.call(v, x + A, P + b)),
                            i.repeatitems) {
                      s || (s = H(x + y + A));
                      ...
                      $.each(s, function(a) {
                        ...
                        return c ? (o = c.textContent || c.text,
                                C[d.p.colModel[a + x + y + A].name] = o,
                                void J.push(D(u, o, a + x + y + A, P + b, t, C))) : !1
                      })
                    } else
                      for (m = 0; m < B.length; m++)
                        o = $.jgrid.getXmlData(t, B[m]),
                            C[d.p.colModel[m + x + y + A].name] = o,
                            J.push(D(u, o, m + x + y + A, P + b, t, C));
                    if (J[Y] = L(u, U, K, C, t),
                            J.push("</tr>"),
                        d.p.grouping && (Q.push(J),
                        d.p.groupingView._locgr || N.call(v, C, P),
                            J = []),
                        (g || d.p.treeGrid === !0 && !d.p._ald) && (C[h] = $.jgrid.stripPref(d.p.idPrefix, u),
                            d.p.data.push(C),
                            d.p._index[C[h]] = d.p.data.length - 1),
                        d.p.gridview === !1 && (T.append(J.join("")),
                            v.triggerHandler("jqGridAfterInsertRow", [u, C, t]),
                        V && d.p.afterInsertRow.call(d, u, C, t),
                            J = []),
                            C = {},
                            w++,
                            P++,
                ...
                if (d.p.gridview === !0 && (n = d.p.treeANode > -1 ? d.p.treeANode : 0,
                        d.p.grouping ? g || (v.jqGrid("groupingRender", Q, d.p.colModel.length, d.p.page, R),
                                Q = null) : d.p.treeGrid === !0 && n > 0 ? $(d.rows[n]).after(J.join("")) : (T.append(J.join("")),
                                    d.grid.cols = d.rows[0].cells)),
                        d.p.totaltime = new Date - f,
                        J = null,
                    d.p.subGrid === !0)
                  try {
                    v.jqGrid("addSubGrid", x + A)
                  } catch (_) {}
                if (w > 0 && 0 === d.p.records && (d.p.records = O),
                    d.p.treeGrid === !0)
                  try {
                ...
                if (d.p.reccount = w,
                        d.p.treeANode = -1,
                    d.p.userDataOnFooter && v.jqGrid("footerData", "set", d.p.userData, !0),
                    g && (d.p.records = O,
                        d.p.lastpage = Math.ceil(O / R)),
                    c || d.updatepager(!1, !0),
                        g) {
                  for (; O > w; ) {
                    if (t = M[w],
                      ...
                      $.each(s, function(a) {
                        ...
                        return b ? (o = b.textContent || b.text,
                                void (C[d.p.colModel[a + x + y + A].name] = o)) : !1
                      })
                    } else
                      for (m = 0; m < B.length; m++)
                        o = $.jgrid.getXmlData(t, B[m]),
                            C[d.p.colModel[m + x + y + A].name] = o;
                    C[h] = $.jgrid.stripPref(d.p.idPrefix, u),
                    d.p.grouping && N.call(v, C, w),
                        d.p.data.push(C),
                        d.p._index[C[h]] = d.p.data.length - 1,
                        C = {},
                        w++
                  ...
                  d.p.grouping && (d.p.groupingView._locgr = !0,
                      v.jqGrid("groupingRender", Q, d.p.colModel.length, d.p.page, R),
                      Q = null)
                }
              }
            }, N = function(a, b, c, e) {
              ...
              if (a) {
                ...
                j && (d.p.data = [],
                    ...
                    "local" === d.p.datatype ? (g = d.p.localReader,
                            ...
                            h = "json");
                var m, o, p, q, r, s, t, u, v, w, x, y = $(d), A = 0, B = [], C = d.p.multiselect ? 1 : 0, J = d.p.subGrid === !0 ? 1 : 0, K = d.p.rownumbers === !0 ? 1 : 0, M = H(C + J + K), N = G(h), O = {}, P = [], Q = k(l, "rowBox", !0, "jqgrow ui-row-" + d.p.direction);
                ...
                J && (r = $.jgrid.getMethod("addSubGridCell")),
                ...
                var R, S = parseInt(d.p.rowNum, 10), T = d.p.scroll ? $.jgrid.randId() : 1, U = !1;
                e && (S *= e + 1),
                "local" !== d.p.datatype || d.p.deselectAfterSort || (U = !0);
                var V, W = $.isFunction(d.p.afterInsertRow), X = [], Y = !1, Z = $(d).find("tbody:first"), _ = K ? k(l, "rownumBox", !1, "jqgrid-rownum") : "", aa = C ? k(l, "multiBox", !1, "cbox") : "";
                for (d.p.grouping && (Y = d.p.groupingView.groupCollapse === !0,
                    V = $.jgrid.getMethod("groupingPrepare")); t > o; ) {
                  if (q = u[o],
                          x = $.jgrid.getAccessor(q, v),
                      void 0 === x && ("number" == typeof v && null != d.p.colModel[v + C + J + K] && (x = $.jgrid.getAccessor(q, d.p.colModel[v + C + J + K].name)),
                      void 0 === x && (x = T + o,
                      0 === B.length && g.cell))) {
                  ...
                  x = d.p.idPrefix + x,
                  U && (R = d.p.multiselect ? -1 !== $.inArray(x, d.p.selarrrow) : x === d.p.selrow);
                  var ca = P.length;
                  for (P.push(""),
                       K && P.push(F(0, o, d.p.page, d.p.rowNum, _)),
                       C && P.push(E(x, K, o, R, aa)),
                       J && P.push(r.call(y, C + K, o + b)),
                           s = N,
                       g.repeatitems && (g.cell && (q = $.jgrid.getAccessor(q, g.cell) || q),
                       $.isArray(q) && (s = M)),
                           p = 0; p < s.length; p++)
                    m = $.jgrid.getAccessor(q, s[p]),
                        O[d.p.colModel[p + C + J + K].name] = m,
                        P.push(D(x, m, p + C + J + K, o + b, q, O));
                  if (Q += R ? " " + n : "",
                          P[ca] = L(x, Y, Q, O, q),
                          P.push("</tr>"),
                      d.p.grouping && (X.push(P),
                      d.p.groupingView._locgr || V.call(y, O, o),
                          P = []),
                      (j || d.p.treeGrid === !0 && !d.p._ald) && (O[i] = $.jgrid.stripPref(d.p.idPrefix, x),
                          d.p.data.push(O),
                          d.p._index[O[i]] = d.p.data.length - 1),
                      d.p.gridview === !1 && (Z.append(P.join("")),
                          y.triggerHandler("jqGridAfterInsertRow", [x, O, q]),
                      W && d.p.afterInsertRow.call(d, x, O, q),
                          P = []),
                          O = {},
                          A++,
                          o++,
                ...
                if (d.p.gridview === !0 && (w = d.p.treeANode > -1 ? d.p.treeANode : 0,
                        d.p.grouping ? j || (y.jqGrid("groupingRender", X, d.p.colModel.length, d.p.page, S),
                                X = null) : d.p.treeGrid === !0 && w > 0 ? $(d.rows[w]).after(P.join("")) : (Z.append(P.join("")),
                                    d.grid.cols = d.rows[0].cells)),
                        d.p.totaltime = new Date - f,
                        P = null,
                    d.p.subGrid === !0)
                ...
                if (A > 0 && 0 === d.p.records && (d.p.records = t),
                    d.p.treeGrid === !0)
                  try {
                    y.jqGrid("setTreeNode", w + 1, A + w + 1)
                  } catch (ea) {}
                if (d.p.reccount = A,
                        d.p.treeANode = -1,
                    d.p.userDataOnFooter && y.jqGrid("footerData", "set", d.p.userData, !0),
                    j && (d.p.records = t,
                        d.p.lastpage = Math.ceil(t / S)),
                    c || d.updatepager(!1, !0),
                        j) {
                  for (; t > A && u[A]; ) {
                    if (q = u[A],
                        ...
                        void 0 === x && (x = T + A,
                        0 === B.length && g.cell))) {
                      var fa = $.jgrid.getAccessor(q, g.cell) || q;
                    ...
                    if (q) {
                      for (x = d.p.idPrefix + x,
                           ...
                           $.isArray(q) && (s = M)),
                               p = 0; p < s.length; p++)
                        O[d.p.colModel[p + C + J + K].name] = $.jgrid.getAccessor(q, s[p]);
                      O[i] = $.jgrid.stripPref(d.p.idPrefix, x),
                      d.p.grouping && V.call(y, O, A),
                          d.p.data.push(O),
                          d.p._index[O[i]] = d.p.data.length - 1,
                          O = {}
                    }
                  ...
                  d.p.grouping && (d.p.groupingView._locgr = !0,
                      y.jqGrid("groupingRender", X, d.p.colModel.length, d.p.page, S),
                      X = null)
                }
              }
            }, O = function(a) {
              function b(a) {
                var c, e, f, g, h, i, j = 0;
                if (null != a.groups) {
                  for (e = a.groups.length && "OR" === a.groupOp.toString().toUpperCase(),
                       e && s.orBegin(),
                ...
                if (null != a.rules)
                  try {
                    for (f = a.rules.length && "OR" === a.groupOp.toString().toUpperCase(),
                         f && s.orBegin(),
                             c = 0; c < a.rules.length; c++)
                      h = a.rules[c],
                          g = a.groupOp.toString().toUpperCase(),
                      r[h.op] && h.field && (j > 0 && g && "OR" === g && (s = s.or()),
                          i = k[h.field],
                      "date" === i.stype && i.srcfmt && i.newfmt && i.srcfmt !== i.newfmt && (h.data = $.jgrid.parseDate.call(d, i.newfmt, h.data, i.srcfmt)),
                          s = r[h.op](s, g)(h.field, h.data, k[h.field])),
                          j++;
                    f && s.orEnd()
                  } catch (m) {
                    alert(m)
              ...
              var c, e, f, g, h = d.p.multiSort ? [] : "", i = [], j = !1, k = {}, l = [], m = [];
              if ($.isArray(d.p.data)) {
                var n, o, p, q = d.p.grouping ? d.p.groupingView : !1;
                if ($.each(d.p.colModel, function() {
                      if (e = this.sorttype || "text",
                              p = this.index || this.name,
                              "date" === e || "datetime" === e ? (this.formatter && "string" == typeof this.formatter && "date" === this.formatter ? (c = this.formatoptions && this.formatoptions.srcformat ? this.formatoptions.srcformat : $.jgrid.getRegional(d, "formatter.date.srcformat"),
                                          f = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat : $.jgrid.getRegional(d, "formatter.date.newformat")) : c = f = this.datefmt || "Y-m-d",
                                      k[p] = {
                                        stype: e,
                                        srcfmt: c,
                                        newfmt: f,
                              ...
                              d.p.grouping)
                        for (o = 0,
                                 n = q.groupField.length; n > o; o++)
                          this.name === q.groupField[o] && (l[o] = k[p],
                              m[o] = p);
                      d.p.multiSort || j || p !== d.p.sortname || (h = p,
                          j = !0)
                    }),
                    d.p.multiSort && (h = t,
                        i = u),
                    d.p.treeGrid && d.p._sort)
                  return void $(d).jqGrid("SortTree", h, d.p.sortorder, k[h].stype || "text", k[h].srcfmt || "");
                var r = {
                  eq: function(a) {
                    return a.equals
                  },
                ...
                if (d.p.ignoreCase && (s = s.ignoreCase()),
                    d.p.search === !0) {
                  var v = d.p.postData.filters;
                  if (v)
                    "string" == typeof v && (v = $.jgrid.parse(v)),
                        b(v);
                  else
                    try {
                      g = k[d.p.postData.searchField],
                      "date" === g.stype && g.srcfmt && g.newfmt && g.srcfmt !== g.newfmt && (d.p.postData.searchString = $.jgrid.parseDate.call(d, g.newfmt, d.p.postData.searchString, g.srcfmt)),
                          s = r[d.p.postData.searchOper](s)(d.p.postData.searchField, d.p.postData.searchString, k[d.p.postData.searchField])
                    } catch (w) {}
                } else
                  d.p.treeGrid && "nested" === d.p.treeGridModel && s.orderBy(d.p.treeReader.left_field, "asc", "integer", "", null);
                if (d.p.treeGrid && "adjacency" === d.p.treeGridModel && (n = 0,
                        h = null),
                        d.p.grouping)
                  for (o = 0; n > o; o++)
                ...
                if ((d.p.search || d.p.resetsearch) && d.p.grouping && d.p.groupingView._locgr) {
                  ...
                  var D, E, F, G = $.jgrid.getMethod("groupingPrepare");
                  if (d.p.footerrow && d.p.userDataOnFooter) {
                    for (E in d.p.userData)
                ...
                return a ? x : (x = d.p.treeGrid && d.p.search ? $(d).jqGrid("searchTree", x) : x.slice((A - 1) * y, A * y),
                        s = null,
                        k = null,
                        C[d.p.localReader.total] = B,
                        C[d.p.localReader.page] = A,
                        C[d.p.localReader.records] = z,
                        C[d.p.localReader.root] = x,
                        C[d.p.localReader.userdata] = d.p.userData,
                        x = null,
                        C)
              }
            }, P = function(a, b) {
              ...
              var e = $(d).triggerHandler("jqGridBeforeProcessing", [a, b, c]);
              return e = void 0 === e || "boolean" != typeof e ? !0 : e,
              $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, a, b, c) === !1 && (e = !1),
                  e
            }, T = function(a, b) {
              $(d).triggerHandler("jqGridLoadComplete", [a]),
              b && d.p.loadComplete.call(d, a),
                  $(d).triggerHandler("jqGridAfterLoadComplete", [a]),
                  d.p.datatype = "local",
                  d.p.datastr = null,
                  R()
            }, U = function(a) {
              if (!d.grid.hDiv.loading) {
                ...
                var p = $(d).triggerHandler("jqGridBeforeRequest");
                if (p === !1 || "stop" === p)
                  return;
                  ...
                  case "script":
                    $.ajax($.extend({
                      ...
                      success: function(c, f, g) {
                        return S(c, f, g) ? ("xml" === b ? M(c, o, a > 1, j) : N(c, o, a > 1, j),
                      ...
                      beforeSend: function(a, b) {
                        var c = !0;
                        return c = $(d).triggerHandler("jqGridLoadBeforeSend", [a, b]),
                        $.isFunction(d.p.loadBeforeSend) && (c = d.p.loadBeforeSend.call(d, a, b)),
                        void 0 === c && (c = !0),
                            c === !1 ? !1 : void Q()
                      }
              ...
              var c, e, f, g, i, j, n, p = "<td class='ui-pg-button " + m + "'><span class='ui-separator'></span></td>", r = "", s = "<table class='ui-pg-table ui-common-table ui-paging-pager'><tbody><tr>", t = "", u = function(a, b) {
                var c;
                return c = $(d).triggerHandler("jqGridPaging", [a, b]),
                    "stop" === c ? !1 : ($.isFunction(d.p.onPaging) && (c = d.p.onPaging.call(d, a, b)),
              ...
              d.p.pginput === !0 && $("#" + c).on("keypress", "input.ui-pg-input", function(a) {
                ...
                return 13 === b ? u("user", this) ? ($(this).val(z($(this).val(), 1)),
                            d.p.page = $(this).val() > 0 ? $(this).val() : d.p.page,
                            U(),
                            !1) : !1 : this
              })
            }, X = function(a, b, c) {
              var e, f = d.p.colModel, g = d.p.frozenColumns ? b : d.grid.headers[a].el, h = "";
              $("span.ui-grid-ico-sort", g).addClass(m),
                  $(g).attr("aria-selected", "false"),
                  e = f[a].index || f[a].name,
                  "undefined" == typeof c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc",
                  ...
                  h ? ($("span.s-ico", g).show(),
                          $("span.ui-icon-" + h, g).removeClass(m),
                          $(g).attr("aria-selected", "true")) : d.p.viewsortcols[0] || $("span.s-ico", g).hide();
              var i = t.indexOf(e);
              -1 === i ? (t.push(e),
                      u.push(h)) : h ? u[i] = h : (u.splice(i, 1),
                          t.splice(i, 1)),
                  d.p.sortorder = "",
                  d.p.sortname = "";
              for (var j = 0, k = t.length; k > j; j++)
                j > 0 && (d.p.sortname += ", "),
                    d.p.sortname += t[j],
                j !== k - 1 && (d.p.sortname += " " + u[j]);
              d.p.sortorder = u[k - 1]
              ...
              var a, b, c, f, g = 0, h = $.jgrid.cell_width ? 0 : z(d.p.cellLayout, 0), i = 0, j = z(d.p.scrollOffset, 0), k = !1, l = 0;
              ...
              var e, f, g = d.p.colModel, h = g.length, i = [], j = $.jgrid.getRegional(d, "colmenu"), k = '<ul id="col_menu" class="ui-search-menu  ui-col-menu modal-content" role="menu" tabindex="0" style="left:' + b + "px;top:" + a + 'px;">';
              for (e = 0; h > e; e++) {
                ...
                for (i.splice(b.startindex, 1),
                  ...
                  $("#col_menu > li > a").on("click", function(a) {
                    ...
                    $(a.target).hasClass("notclick") || ($(a.target).is(":input") ? b = $(a.target).is(":checked") : (b = !$("input", this).is(":checked"),
                        ...
                        b ? ($(d).jqGrid("showCol", $("input", this).attr("name")),
                                $(this).parent().attr("draggable", "true")) : ($(d).jqGrid("hideCol", $("input", this).attr("name")),
              ...
              var c = d.p.colModel[a]
                  , e = d.p.groupingView;
              -1 !== b ? e.groupField.splice(b, 1) : e.groupField.push(c.name),
              ...
              b = parseInt(b, 10),
                  c = parseInt(c, 10) + 25;
              var e, f, g = $(".ui-jqgrid-view").css("font-size") || "11px", h = '<ul id="column_menu" class="ui-search-menu modal-content column-menu" role="menu" tabindex="0" style="font-size:' + g + ";left:" + b + "px;top:" + c + 'px;">', i = d.p.colModel[a], j = $.extend({
                sorting: !0,
                columns: !0,
                filtering: !0,
                seraching: !0,
              ...
              if (j.sorting && (h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_sort_asc + '"></span></td><td class="menu_text">' + k.sortasc + "</td></tr></table></a></li>",
                      h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_sort_desc + '"></span></td><td class="menu_text">' + k.sortdesc + "</td></tr></table></a></li>"),
                  j.columns && (h += '<li class="ui-menu-item divider" role="separator"></li>',
                      h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="columns"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_columns + '"></span></td><td class="menu_text">' + k.columns + "</td></tr></table></a></li>"),
                  j.filtering && (h += '<li class="ui-menu-item divider" role="separator"></li>',
                      h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="filtering"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_filter + '"></span></td><td class="menu_text">' + k.filter + " " + (i.label || i.name) + "</td></tr></table></a></li>"),
                  j.grouping && (e = $.inArray(i.name, d.p.groupingView.groupField),
                      h += '<li class="ui-menu-item divider" role="separator"></li>',
                      h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="grouping"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_group + '"></span></td><td class="menu_text">' + (-1 !== e ? k.ungrouping : k.grouping + " " + (i.label || i.name)) + "</td></tr></table></a></li>"),
                  j.freeze && (f = i.frozen && d.p.frozenColumns ? !1 : !0,
                      h += '<li class="ui-menu-item divider" role="separator"></li>',
                      h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" value="freeze"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + q + " " + r.icon_freeze + '"></span></td><td class="menu_text">' + (f ? k.freeze + " " + (i.label || i.name) : k.unfreeze) + "</td></tr></table></a></li>"),
                      h += "</ul>",
                      $("body").append(h),
                      $("#column_menu").addClass("ui-menu " + r.menu_widget),
                  "ltr" === d.p.direction) {
                var l = $("#column_menu").width() + 26;
                $("#column_menu").css("left", b - l + "px")
              }
              $("#column_menu > li > a").hover(function() {
                $("#col_menu").remove(),
                    $("#search_menu").remove();
                var b, c;
                "columns" === $(this).attr("value") && (b = $(this).parent().width() + 18,
                    c = $(this).parent().position().top - 5,
                    ca(c, b, $(this).parent())),
                "filtering" === $(this).attr("value") && (b = $(this).parent().width() + 18,
                    c = $(this).parent().position().top - 5,
                    da(a, c, b, $(this).parent())),
                    $(this).addClass(o)
              }, function() {
                $(this).removeClass(o)
              }).click(function() {
                ...
                "sortasc" === b ? Y("jqgh_" + d.p.id + "_" + i.name, a, !0, "asc", c) : "sortdesc" === b ? Y("jqgh_" + d.p.id + "_" + i.name, a, !0, "desc", c) : "grouping" === b ? fa(a, e) : "freeze" === b && ga(a, f),
            ...
            for (d.p.colMenu && $("body").on("click", function(a) {
              $(a.target).closest(".column-menu").length || $("#column_menu").remove()
                     ...
                     this.p.id = this.id,
                 -1 === $.inArray(d.p.multikey, y) && (d.p.multikey = !1),
                     d.p.keyName = !1,
                     i = 0; i < d.p.colModel.length; i++)
              x = "string" == typeof d.p.colModel[i].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[d.p.colModel[i].template] ? $.jgrid.cmTemplate[d.p.colModel[i].template] : {} : d.p.colModel[i].template,
                  d.p.colModel[i] = $.extend(!0, {}, d.p.cmTemplate, x || {}, d.p.colModel[i]),
            ...
            d.p.data.length && (J(),
                K());
            var ka, la, ma, na, oa, pa, qa, ra, sa, ta = "<thead><tr class='ui-jqgrid-labels' role='row'>", ua = "", va = "", wa = "";
            ...
            if ("horizontal" === d.p.viewsortcols[1] ? (va = " ui-i-asc",
                        wa = " ui-i-desc") : "single" === d.p.viewsortcols[1] && (va = " ui-single-sort-asc",
                        wa = " ui-single-sort-desc",
                        ua = " style='display:none'",
                        d.p.viewsortcols[0] = !1),
                    ka = s ? "class='ui-th-div-ie'" : "",
                    ra = "<span class='s-ico' style='display:none'>",
                    ra += "<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc" + va + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_asc", !0) + "'" + ua + "></span>",
                    ra += "<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + wa + " ui-sort-" + h + " " + m + " " + q + " " + k(l, "icon_desc", !0) + "'" + ua + "></span></span>",
                d.p.multiSort && d.p.sortname)
              for (t = d.p.sortname.split(","),
                       i = 0; i < t.length; i++)
                v = $.trim(t[i]).split(" "),
                    t[i] = $.trim(v[0]),
                    u[i] = v[1] ? $.trim(v[1]) : d.p.sortorder || "asc";
            for (i = 0; i < this.p.colNames.length; i++) {
              var xa = d.p.headertitles ? ' title="' + $.jgrid.stripHtml(d.p.colNames[i]) + '"' : "";
              sa = d.p.colModel[i],
              sa.hasOwnProperty("colmenu") || (sa.colmenu = "rn" === sa.name || "cb" === sa.name || "subgrid" === sa.name ? !1 : !0),
                  ta += "<th id='" + d.p.id + "_" + sa.name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + xa + ">",
                  la = sa.index || sa.name,
                  ta += "<div class='ui-th-div' id='jqgh_" + d.p.id + "_" + sa.name + "' " + ka + ">" + d.p.colNames[i],
                  sa.width ? sa.width = parseInt(sa.width, 10) : sa.width = 150,
              "boolean" != typeof sa.title && (sa.title = !0),
                  sa.lso = "",
              la === d.p.sortname && (d.p.lastsort = i),
              d.p.multiSort && (v = $.inArray(la, t),
              -1 !== v && (sa.lso = u[v])),
                  ta += ra,
              d.p.colMenu && sa.colmenu && (ta += "<a class='colmenu' href='#/'><span class='colmenuspan " + q + " " + r.icon_menu + "'></span></a>"),
                  ta += "</div></th>"
            }
            if (ta += "</tr></thead>",
                    ra = null,
              ...
              $("#cb_" + $.jgrid.jqID(d.p.id), this).on("click", function() {
                ...
                this.checked ? ($(d.rows).each(function(b) {
                      ...
                      a && ($("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + $.jgrid.jqID(this.id), d.grid.fbDiv)[d.p.useProp ? "prop" : "attr"]("checked", !1),
                        ...
                        d.p.selrow = null,
                        ya = !1),
                    $(d).triggerHandler("jqGridSelectAll", [ya ? d.p.selarrrow : za, ya]),
                $.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, ya ? d.p.selarrrow : za, ya)
              })
            }
            if (d.p.autowidth === !0) {
              var Aa = $(w).innerWidth();
              d.p.width = Aa > 0 ? Aa : "nw"
            }
            Z(),
            ...
            d.p.scrollPopUp && $(w).append("<div " + k(l, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + d.p.id + "'></div>"),
                ...
                ta = $("thead:first", d).get(0);
            var Ba = "";
            d.p.footerrow && (Ba += "<table role='presentation' style='width:" + d.p.tblwidth + "px' " + k(l, "footerTable", !1, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + k(l, "footerBox", !1, "footrow footrow-" + h) + ">");
            var Ca = $("tr:first", ta)
                , Da = "<tr class='jqgfirstrow' role='row'>";
            if (d.p.disableClick = !1,
                    $("th", Ca).each(function(a) {
                      sa = d.p.colModel[a],
                          ma = sa.width,
                      void 0 === sa.resizable && (sa.resizable = !0),
                          sa.resizable ? (na = document.createElement("span"),
                                  $(na).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"),
                                  $(this).addClass(d.p.resizeclass)) : na = "",
                          $(this).css("width", ma + "px").prepend(na),
                          na = null;
                      var b = "";
                      sa.hidden && ($(this).css("display", "none"),
                          b = "display:none;"),
                          Da += "<td role='gridcell' style='height:0px;width:" + ma + "px;" + b + "'></td>",
                          e.headers[a] = {
                            width: ma,
                            el: this
                          },
                          ua = sa.sortable,
                      "boolean" != typeof ua && (sa.sortable = !0,
                          ua = !0);
                      var c = sa.name;
                      "cb" !== c && "subgrid" !== c && "rn" !== c && d.p.viewsortcols[2] && $(">div", this).addClass("ui-jqgrid-sortable"),
                      ua && (d.p.multiSort ? d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(),
                              d.tmpcm.lso && $("div span.ui-icon-" + sa.lso, this).removeClass(m).css("display", "")) : sa.lso && ($("div span.s-ico", this).show(),
                                  $("div span.ui-icon-" + sa.lso, this).removeClass(m).css("display", "")) : d.p.viewsortcols[0] ? ($("div span.s-ico", this).show(),
                      ...
                      d.p.footerrow && (Ba += "<td role='gridcell' " + A(a, 0, "", null, "", !1) + ">&#160;</td>")
                    }).mousedown(function(a) {
                      if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
                        var b = ba(this);
                        return d.p.forceFit === !0 && (d.p.nv = _(b)),
                            e.dragStart(b, a, aa(b)),
                            !1
                      }
                    }).click(function(a) {
                      if (d.p.disableClick)
                      ...
                      if (1 === f.length) {
                        ...
                        if ($(a.target).hasClass("colmenuspan")) {
                          ...
                          var j = $(this).offset()
                              , k = j.left
                              , l = j.top;
                          return "ltr" === d.p.direction && (k += $(this).outerWidth()),
                              ha(i, k, l, f),
                              void a.stopPropagation()
                        }
                        return d.p.viewsortcols[2] || (b = !0,
                            c = f.attr("sort")),
                        null != g && Y($("div", this)[0].id, g, b, c, this),
                            !1
                      }
                    }),
                    sa = null,
              ...
              try {
                $(d).jqGrid("sortableColumns", Ca)
              } catch (Ea) {}
            d.p.footerrow && (Ba += "</tr></tbody></table>"),
                Da += "</tr>",
                qa = document.createElement("tbody"),
                this.appendChild(qa),
                $(this).addClass(k(l, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Da),
            d.p.altRows && $(this).addClass(k(l, "stripedTable", !0, "")),
                Da = null;
            var Fa = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ta)
                , Ga = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1
                , Ha = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>")
                , Ia = "Bootstrap" !== d.p.styleUI || isNaN(d.p.height) ? 0 : 2;
            ta = null,
                e.hDiv = document.createElement("div"),
                e.hDiv.style.width = e.width - Ia + "px",
            ...
            d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"),
                $(d.p.pager).css({
                  width: e.width + "px"
                }).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(w),
            Ga && $(d.p.pager).hide(),
                W(d.p.pager, "")),
            d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).on({
              mouseover: function(a) {
                pa = $(a.target).closest("tr.jqgrow"),
                "ui-subgrid" !== $(pa).attr("class") && $(pa).addClass(o)
              },
              mouseout: function(a) {
                pa = $(a.target).closest("tr.jqgrow"),
                    $(pa).removeClass(o)
            ...
            $(d).before(e.hDiv).on({
              click: function(a) {
                if (oa = a.target,
                        pa = $(oa, d.rows).closest("tr.jqgrow"),
                    0 === $(pa).length || pa[0].className.indexOf(m) > -1 || ($(oa, d).closest("table.ui-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== d.id)
                  return this;
                var b = $(oa).filter(":enabled").hasClass("cbox")
                    , c = $(d).triggerHandler("jqGridBeforeSelectRow", [pa[0].id, a]);
                if (c = c === !1 || "stop" === c ? !1 : !0,
                        $.isFunction(d.p.beforeSelectRow)) {
                  var e = d.p.beforeSelectRow.call(d, pa[0].id, a);
                  (e === !1 || "stop" === e) && (c = !1)
                }
                if ("A" !== oa.tagName && ("INPUT" !== oa.tagName && "TEXTAREA" !== oa.tagName && "OPTION" !== oa.tagName && "SELECT" !== oa.tagName || b))
                  if (Ja = pa[0].id,
                          oa = $(oa).closest("tr.jqgrow>td"),
                      oa.length > 0 && (Ka = $.jgrid.getCellIndex(oa),
                          La = $(oa).closest("td,th").html(),
                          $(d).triggerHandler("jqGridCellSelect", [Ja, Ka, La, a]),
                      $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, Ja, Ka, La, a)),
                      d.p.cellEdit !== !0) {
                    if (c)
                      if (d.p.multikey)
                        a[d.p.multikey] ? $(d).jqGrid("setSelection", Ja, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ja).is(":checked"),
                                $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + Ja)[d.p.useProp ? "prop" : "attr"]("checked", !b));
                      else if (d.p.multiselect && d.p.multiboxonly)
                        if (b)
                          $(d).jqGrid("setSelection", Ja, !0, a);
                        else {
                    ...
                    try {
                      $(d).jqGrid("editCell", pa[0].rowIndex, Ka, !0)
                    } catch (g) {}
              },
                ...
                if (d.p.treeGrid === !0 && (d.p.datatype = d.p.treedatatype),
                    ...
                    b.current && d.grid.selectionPreserver(d),
                        "local" === d.p.datatype ? ($(d).jqGrid("resetSelection"),
                            d.p.data.length && (J(),
                                K())) : d.p.treeGrid || (d.p.selrow = null,
                            d.p.multiselect && (d.p.selarrrow = [],
                                V(!1)),
                                d.p.savedRow = []),
                    d.p.scroll && I.call(d, !0, !1),
                        b.page) {
                  var c = b.page;
              ...
              dblclick: function(a) {
                if (oa = a.target,
                    ...
                    0 !== $(pa).length) {
                  Ja = pa[0].rowIndex,
                      Ka = $.jgrid.getCellIndex(oa);
                  var b = $(d).triggerHandler("jqGridDblClickRow", [$(pa).attr("id"), Ja, Ka, a]);
                  return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(pa).attr("id"), Ja, Ka, a),
                      null != b) ? b : void 0
                }
              },
              contextmenu: function(a) {
                if (oa = a.target,
                        pa = $(oa, d.rows).closest("tr.jqgrow"),
                    0 !== $(pa).length) {
                  d.p.multiselect || $(d).jqGrid("setSelection", pa[0].id, !0, a),
                      Ja = pa[0].rowIndex,
                      Ka = $.jgrid.getCellIndex(oa);
                  var b = $(d).triggerHandler("jqGridRightClickRow", [$(pa).attr("id"), Ja, Ka, a]);
                  return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(pa).attr("id"), Ja, Ka, a),
                      null != b) ? b : void 0
                }
              }
            }),
            ...
            d.p.multikey && ($.jgrid.msie() ? $(e.bDiv).on("selectstart", function() {
                  return !1
                }) : $(e.bDiv).on("mousedown", function() {
                  return !1
                })),
            Ga && $(e.bDiv).hide();
            var Ma = q + " " + k(l, "icon_caption_open", !0)
                , Na = q + " " + k(l, "icon_caption_close", !0);
            e.cDiv = document.createElement("div");
            var Oa = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function() {
                  Oa.addClass(o)
                }, function() {
                  Oa.removeClass(o)
                }).append("<span class='ui-jqgrid-headlink " + Ma + "'></span>").css("rtl" === h ? "left" : "right", "0px") : "";
            if ($(e.cDiv).append(Oa).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)),
                    $(e.cDiv).insertBefore(e.hDiv),
                    d.p.toolbar[0]) {
              var Pa = k(l, "customtoolbarBox", !0, "ui-userdata");
              e.uDiv = document.createElement("div"),
                  ...
                  "both" === d.p.toolbar[1] ? (e.ubDiv = document.createElement("div"),
                          $(e.uDiv).addClass(Pa + " ui-userdata-top").attr("id", "t_" + this.id).insertBefore(e.hDiv).width(e.width - Ia),
                          $(e.ubDiv).addClass(Pa + " ui-userdata-bottom").attr("id", "tb_" + this.id).insertAfter(e.hDiv).width(e.width - Ia),
                      Ga && $(e.ubDiv).hide()) : $(e.uDiv).width(e.width - Ia).addClass(Pa + " ui-userdata-top").attr("id", "t_" + this.id),
              Ga && $(e.uDiv).hide()
            }
            if (d.p.toppager && (d.p.toppager = $.jgrid.jqID(d.p.id) + "_toppager",
                    e.topDiv = $("<div id='" + d.p.toppager + "'></div>")[0],
                    d.p.toppager = "#" + d.p.toppager,
                    $(e.topDiv).addClass(k(l, "toppagerBox", !0, "ui-jqgrid-toppager")).width(e.width - Ia).insertBefore(e.hDiv),
                    W(d.p.toppager, "_t")),
                d.p.footerrow && (e.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0],
                    Ha = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>"),
                    $(e.sDiv).append(Ha).width(e.width - Ia).insertAfter(e.hDiv),
                    $(Ha).append(Ba),
              ...
              d.p.hidegrid === !0 && ($(".ui-jqgrid-titlebar-close", e.cDiv).click(function(a) {
                ...
                return d.p.toolbar[0] === !0 && ("both" === d.p.toolbar[1] && (f += ", #" + $(e.ubDiv).attr("id")),
                    ...
                    "visible" === d.p.gridstate ? $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideUp("fast", function() {
                          b--,
                          0 === b && ($("span", g).removeClass(Ma).addClass(Na),
                          ...
                          c && (Ga || d.p.onHeaderClick.call(d, d.p.gridstate, a)))
                        }) : "hidden" === d.p.gridstate && $(f, "#gbox_" + $.jgrid.jqID(d.p.id)).slideDown("fast", function() {
                          b--,
                          0 === b && ($("span", g).removeClass(Na).addClass(Ma),
                          Ga && (d.p.datatype = Qa,
                              U(),
                              Ga = !1),
            ...
            if ($(e.hDiv).after(e.bDiv).mousemove(function(a) {
                ...
                $.isFunction(d.p.onInitGrid) && d.p.onInitGrid.call(d),
                    ...
                    d.p.hiddengrid = !1,
                    d.p.responsive) {
              var Ra = "onorientationchange"in window
                  , Sa = Ra ? "orientationchange" : "resize";
              $(window).on(Sa, function() {
                $(d).jqGrid("resizeGrid")
              })
            }
          }
      ...
      $.jgrid.extend({
          ...
          return b && ($.isArray(b) ? (m = !0,
              ...
              this.each(function() {
                ...
                for (i && (s = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "rownumBox", !1, "jqgrid-rownum")),
                  ...
                  v.p.subGrid === !0 && $(v).jqGrid("addSubGrid", g + i, j),
                      v.p.records++,
                      v.p.reccount++,
        ...
        setGridWidth: function(a, b) {
          return this.each(function() {
            if (this.grid) {
              var c, d, e, f, g = this, h = 0, i = $.jgrid.cell_width ? 0 : g.p.cellLayout, j = 0, k = !1, l = g.p.scrollOffset, m = 0, n = "Bootstrap" === g.p.styleUI ? 2 : 0;
              if ("boolean" != typeof b && (b = g.p.shrinkToFit),
                ...
                if (a = parseInt(a, 10),
                    ...
                    "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a - n + "px")),
        ...
        getCell: function(a, b) {
          ...
          return this.each(function() {
            var d, e, f = this, g = -1;
            if (f.grid && (d = b,
                    isNaN(b) ? $(f.p.colModel).each(function(a) {
                          return this.name === b ? (d = this.name,
                                  g = a,
                                  !1) : void 0
                        }) : g = parseInt(b, 10),
                g >= 0)) {
              ...
              if (a.p.subGrid !== !0 && a.p.treeGrid !== !0 && a.p.cellEdit !== !0 && !a.p.sortable && !a.p.scroll) {
                ...
                if (e >= 0 && f) {
                  var k = a.p.caption ? $(a.grid.cDiv).outerHeight() : 0
                      , l = parseInt($(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).outerHeight(), 10);
                  a.p.toppager && (k += $(a.grid.topDiv).outerHeight()),
                  a.p.toolbar[0] === !0 && "bottom" !== a.p.toolbar[1] && (k += $(a.grid.uDiv).outerHeight()),
                      a.grid.fhDiv = $('<div style="position:absolute;' + ("rtl" === a.p.direction ? "right:0;" : "left:0;") + "top:" + k + "px;height:" + (l - j) + 'px;" class="frozen-div ' + g + '"></div>'),
                      a.grid.fbDiv = $('<div style="position:absolute;' + ("rtl" === a.p.direction ? "right:0;" : "left:0;") + "top:" + (parseInt(k, 10) + parseInt(l, 10) + 1 - j) + 'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'),
                      $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fhDiv);
                  var m = $(".ui-jqgrid-htable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                  if (a.p.groupHeader) {
                    $("tr.jqg-first-row-header, tr.jqg-third-row-header", m).each(function() {
                      $("th:gt(" + e + ")", this).remove()
                    });
                    var n, o, p = -1, q = -1;
                    $("tr.jqg-second-row-header th", m).each(function() {
                      return n = parseInt($(this).attr("colspan"), 10),
                          o = parseInt($(this).attr("rowspan"), 10),
                      o && (p++,
                          q++),
                      n && (p += n,
                          q++),
                    ...
                    p !== e && (q = e),
                        $("tr.jqg-second-row-header", m).each(function() {
                          $("th:gt(" + q + ")", this).remove()
                        })
                  } else
                    $("tr", m).each(function() {
                  ...
                  if ($(m).width(1),
                      $.jgrid.msie() || $(m).css("height", "100%"),
                          $(a.grid.fhDiv).append(m).mousemove(function(b) {
                            return a.grid.resizing ? (a.grid.dragMove(b),
                                    !1) : void 0
                          }),
                          a.p.footerrow) {
                    var r = $(".ui-jqgrid-bdiv", "#gview_" + $.jgrid.jqID(a.p.id)).height();
                    a.grid.fsDiv = $('<div style="position:absolute;left:0px;top:' + (parseInt(k, 10) + parseInt(l, 10) + parseInt(r, 10) + 1 - j) + 'px;" class="frozen-sdiv ui-jqgrid-sdiv"></div>'),
                        $("#gview_" + $.jgrid.jqID(a.p.id)).append(a.grid.fsDiv);
                    var s = $(".ui-jqgrid-ftable", "#gview_" + $.jgrid.jqID(a.p.id)).clone(!0);
                    $("tr", s).each(function() {
                      $("td:gt(" + e + ")", this).remove()
                    }),
                        $(s).width(1),
                        $(a.grid.fsDiv).append(s)
                  }
                  ...
                  a.p.hoverrows === !0 && $("#" + $.jgrid.jqID(a.p.id)).off("mouseover mouseout"),
                      $(a).on("jqGridAfterGridComplete.setFrozenColumns", function() {
                        $("#" + $.jgrid.jqID(a.p.id) + "_frozen").remove(),
                            $(a.grid.fbDiv).height($(a.grid.bDiv).height() - 14);
                        var b = [];
        ...
        resizeColumn: function(a, b, c) {
          return this.each(function() {
            var d, e, f, g = this.grid, h = this.p, i = h.colModel, j = i.length;
            if ("string" == typeof a) {
              for (d = 0; j > d; d++)
                if (i[d].name === a) {
                  a = d;
              ...
              a = parseInt(a, 10);
            if (void 0 === c && (c = !1),
                (i[a].resizable || c) && (b = parseInt(b, 10),
                    !("number" != typeof a || 0 > a || a > i.length - 1 || "number" != typeof b || b < h.minColWidth))) {
              if (h.forceFit)
                for (h.nv = 0,
                         d = a + 1; j > d; d++)
                  if (i[d].hidden !== !0) {
              ...
              if (g.resizing = {
                    idx: a
                      ...
                      e = b - g.headers[a].width,
                      h.forceFit) {
                if (f = g.headers[a + h.nv].width - e,
                    f < h.minColWidth)
                  return;
                g.headers[a + h.nv].newWidth = g.headers[a + h.nv].width - e
              }
              g.newWidth = h.tblwidth + e,
          ...
          return this.each(function() {
            ...
            if (h.grid && h.p.cellEdit === !0) {
              ...
              if (g = h.p.colModel[b],
                ...
                if (g.editable !== !0 || c !== !0 || f.hasClass("not-editable-cell") || $.isFunction(h.p.isCellEditable) && !h.p.isCellEditable.call(h, d, a, b))
                  ...
                  if (h.p.autoencode && (e = $.jgrid.htmlDecode(e)),
                    ...
                    var n = h.p.formatCell.call(h, h.rows[a].id, d, e, a, b);
                    void 0 !== n && (e = n)
                  }
                  ...
                  var o = $.extend({}, g.editoptions || {}, {
                    id: a + "_" + d,
                    name: d,
                    rowId: h.rows[a].id,
                    oper: "edit"
                  })
                      , p = $.jgrid.createEl.call(h, g.edittype, o, e, !0, $.extend({}, $.jgrid.ajaxOptions, h.p.ajaxSelectOptions || {}));
                  $.inArray(g.edittype, ["text", "textarea", "password", "select"]) > -1 && $(p).addClass(k),
                      f.html("").append(p).attr("tabindex", "0"),
                      $.jgrid.bindEv.call(h, p, o),
                      window.setTimeout(function() {
                        $(p).focus()
                      }, 1),
                      $("input, select, textarea", f).on("keydown", function(c) {
              ...
              if (c = d.p.savedRow.length >= 1 ? 0 : null,
                ...
                if (h !== d.p.savedRow[c].v) {
                  ...
                  if (t[0] === !0) {
                              ...
                              complete: function(c, j) {
                                if ($(d).jqGrid("progressBar", {
                                      ...
                                      loadtype: d.p.loadui
                                        ...
                                        d.grid.hDiv.loading = !1,
                                    "success" === j) {
                                  var n = $(d).triggerHandler("jqGridAfterSubmitCell", [d, c, w.id, k, g, a, b]) || [!0, ""];
                                  n[0] === !0 && $.isFunction(d.p.afterSubmitCell) && (n = d.p.afterSubmitCell.call(d, c, w.id, k, g, a, b)),
                                      n[0] === !0 ? (u && (g = ""),
                                              $(i).empty(),
                                          ...
                                          $.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.rows[a].id, k, g, a, b),
                                              d.p.savedRow.splice(0, 1)) : ($.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, c, j) : $.jgrid.info_dialog(e.errcap, n[1], f.bClose, {
                                                styleUI: d.p.styleUI,
                                                top: m.top + 30,
                                                left: m.left,
                                                onClose: function() {
                                                  d.p.restoreCellonFail || $("#" + a + "_" + l, d.rows[a]).focus()
                                                }
                                              }),
                    ...
                    try {
                      $.isFunction(d.p.validationCell) ? d.p.validationCell.call(d, $("#" + a + "_" + l, d.rows[a]), t[1], a, b) : (window.setTimeout(function() {
      ...
      $.extend($.jgrid, {
                        ...
                        if ("string" == typeof l && (l = $($.trim(l)).html()),
                          ...
                          if ($(d).append(l),
                            ...
                            if ("edit" === g.oper)
                              ...
                              $.each(o, function(a) {
                                return m = this.index || this.name,
                                    g.name === m ? (this.searchoptions.dataUrl = null,
        ...
        isEmpty: function(a) {
          return void 0 === a || a.match(/^\s+$/) || "" === a ? !0 : !1
        },
              ...
              this.onchange = function() {
                return this.p.error = !1,
                  ...
                  this.createTableForGroup = function(a, b) {
                    ...
                    if (v)
                      for (var w = 0; w < e.p.columns.length; w++)
                        e.p.columns[w].inlist && (e.p.columns[w].search = !0);
                    if (void 0 !== a.rules)
                  ...
                  this.createTableRowForRule = function(a, b) {
                    ...
                    o.append(B),
                        ...
                        $(z).addClass("input-elm " + h.srInput).on("change", function() {
                    ...
                    if (o.append(C),
                        this.p.ruleButtons === !0) {
                      var D = $("<input type='button' value='-' title='" + m.p.delrule + "' class='delete-rule ui-del " + i.button + "'/>");
                      C.append(D),
                          D.on("click", function() {
                  ...
                  this.getStringForRule = function(a) {
                    ...
                    return void 0 === c ? "" : (f = this.p.autoencode ? $.jgrid.htmlEncode(a.data) : a.data,
                        ("bw" === h || "bn" === h) && (f += "%"),
                        ("ew" === h || "en" === h) && (f = "%" + f),
                        ("cn" === h || "nc" === h) && (f = "%" + f + "%"),
                        ("in" === h || "ni" === h) && (f = " (" + f + ")"),
                  ...
                  var d, e, f, g = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].filter, h = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].common, i = $.jgrid.styleUI[c.p.styleUI || "jQueryUI"].base, j = function() {
                    ...
                    $.each(c.p.colModel, function() {
                      ...
                      if (d = this.index || this.name,
                              ...
                              e = a.searchOperators && f.searchOperMenu ? m.parent().prev().children("a").attr("soper") || a.defaultSearch : f.sopt ? f.sopt[0] : "select" === this.stype ? "eq" : a.defaultSearch,
                              b = "custom" === this.stype && $.isFunction(f.custom_value) && m.length > 0 && "SPAN" === m[0].nodeName.toUpperCase() ? f.custom_value.call(c, m.children(".customelement:first"), "get") : m.val(),
                    ...
                    if (a.stringResult === !0 || "local" === c.p.datatype || a.searchOperators === !0) {
                      ...
                      $.each(g, function(a, b) {
                        o > 0 && (n += ","),
                          ...
                          n += "]}";
                      var p, q, r, s, t, u, v;
                      if (j && (p = $.jgrid.parse(n),
                          p.rules && p.rules.length))
                        for (q = p.rules,
                                 r = 0; r < q.length; r++)
                          t = q[r],
                          $.inArray(t.filed, k) && (u = t.data.split(a.splitSelect),
                          u.length > 1 && (void 0 === p.groups && (p.groups = []),
                              v = {
                              ...
                              q.splice(r, 1),
                              r--));
                      if (l && ($.isPlainObject(p) || (p = $.jgrid.parse(n)),
                          p.rules && p.rules.length))
                        for (q = p.rules,
                                 r = 0; r < q.length; r++)
                          t = q[r],
                          "bt" === t.op && (u = t.data.split("..."),
                          u.length > 1 && (void 0 === p.groups && (p.groups = []),
                              v = {
                                groupOp: "AND",
                                groups: [],
                ...
                function b(e) {
                  if (e && e.rules) {
                    for (f = e.rules,
                      ...
                      g = f[c],
                          h = $.inArray(g.field, l),
                      -1 !== h && (d = $("#gs_" + i.p.idPrefix + $.jgrid.jqID(j[h].name)),
                      d.length > 0 && ("select" === j[h].stype ? d.find("option[value='" + $.jgrid.jqID(g.data) + "']").prop("selected", !0) : "text" === j[h].stype && d.val(g.data),
                      $.isFunction(a.onSetVal) && a.onSetVal.call(i, d, j[h].name)));
                    if (e.groups)
                      for (var m = 0; m < e.groups.length; m++)
                        b(e.groups[m])
                  }
                }
                var c, d, e, f, g, h, i = this, j = i.p.colModel, k = i.p.colModel.length, l = [];
                if (i.p.filterToolbar) {
                  for (c = 0; k > c; c++) {
                    switch (l.push(j[c].name),
                        d = $("#gs_" + i.p.idPrefix + $.jgrid.jqID(j[c].name)),
                        j[c].stype) {
                      case "select":
                      case "text":
                        d.val("")
                  ...
                  if ("_empty" !== a && (p = $(b).jqGrid("getInd", a)),
                          $(b.p.colModel).each(function(l) {
                            if (f = this.name,
                              ...
                              if ("_empty" === a && t.defaultValue && (i = $.isFunction(t.defaultValue) ? t.defaultValue.call(q) : t.defaultValue),
                                  this.edittype || (this.edittype = "text"),
                                  q.p.autoencode && (i = $.jgrid.htmlDecode(i)),
                                      k = $.jgrid.createEl.call(q, this.edittype, t, i, !1, $.extend({}, $.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {})),
                                ...
                                if (h = $(c).find("tr[rowpos=" + v + "]"),
                                        u.rowabove) {
                                  var z = $("<tr><td class='contentinfo' colspan='" + 2 * d + "'>" + u.rowcontent + "</td></tr>");
                                  $(c).append(z),
                                      z[0].rp = v
                                }
                                0 === h.length && (h = $("<tr " + j + " rowpos='" + v + "'></tr>").addClass("FormData").attr("id", "tr_" + f),
                                    $(h).append(s),
                                    $(c).append(h),
                                    h[0].rp = v),
                                    $("td:eq(" + (x - 2) + ")", h[0]).html("<label for='" + f + "'>" + (void 0 === u.label ? b.p.colNames[l] : u.label) + "</label>"),
                                    $("td:eq(" + (x - 1) + ")", h[0]).append(u.elmprefix).append(k).append(u.elmsuffix)
                              }
                              (rp_ge[q.p.id].checkOnSubmit || rp_ge[q.p.id].checkOnUpdate) && m && (q.p.savedData[f] = i),
                              "custom" === this.edittype && $.isFunction(t.custom_value) && t.custom_value.call(q, $("#" + f, w), "set", i),
                                  $.jgrid.bindEv.call(q, k, t),
                                  o[n] = l,
                                  n++
                            }
                          }),
                ...
                function g(a, b, c) {
                  ...
                  if ("_empty" === a)
                    return $(k).each(function() {
                      ...
                      (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (q.p.savedData[d] = h))
                    }),
                        void $("#id_g", c).val(a);
                  ...
                  l && ($('td[role="gridcell"]', l).each(function(f) {
                    if (d = k[f].name,
                      ...
                      (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (q.p.savedData[d] = e),
                          d = $.jgrid.jqID(d),
                          k[f].edittype) {
                        case "password":
                        case "text":
                  ...
                  j > 0 && ($("#id_g", y).val(a),
                  (rp_ge[q.p.id].checkOnSubmit === !0 || rp_ge[q.p.id].checkOnUpdate) && (q.p.savedData[b.p.id + "_id"] = a)))
                }
                function h() {
                          ...
                          $(".FormError", w).html(l[1]),
                              ...
                              s[a] = $.jgrid.htmlDecode(b)
                                ...
                                s[d] === n.addoper ? (l[2] || (l[2] = $.jgrid.randId()),
                                        null == s[c] || "_empty" === s[c] || "" == s[c] ? s[c] = l[2] : l[2] = s[c],
                      ...
                      return k() ? ($.jgrid.hideModal("#" + $.jgrid.jqID(z.themodal), {
                        ...
                        $("#sData", r).click(function() {
                          return s = {},
                              $(".FormError", w).hide(),
                              c(),
                              "_empty" === s[q.p.id + "_id"] ? i() : b.checkOnSubmit === !0 ? (t = j(s, q.p.savedData),
                                          t ? ($(w).data("disabled", !0),
            ...
            saveState: function(a, b) {
              if (b = $.extend({
                ...
                if (g.grid) {
                  ...
                  if ($.isFunction(b.beforeSetItem) && (c = b.beforeSetItem.call(g, e),
                      null != c && (e = c)),
                          b.debug) {
                ...
                if (b) {
                  ...
                  if (d = jqGridUtils.parse(b),
                    ...
                    d.filterToolbar && (h = k(d._fT),
                        ...
                        delete d._fT);
                    var m = $("#" + a).jqGrid(d);
                    if (c.restoreData && "" !== $.trim(f) && m.append(f),
                    ...
                    if (d.treeGrid)
                      for (var q = 1, r = m[0].rows.length, s = d.expColInd, t = d.treeReader.leaf_field, u = d.treeReader.expanded_field; r > q; )
                        $(m[0].rows[q].cells[s]).find("div.treeclick").on("click", function(a) {
                          var b = a.target || a.srcElement
                              , c = $.jgrid.stripPref(d.idPrefix, $(b, m[0].rows).closest("tr.jqgrow")[0].id)
                              , e = m[0].p._index[c];
                          return m[0].p.data[e][t] || (m[0].p.data[e][u] ? (m.jqGrid("collapseRow", m[0].p.data[e]),
                                  m.jqGrid("collapseNode", m[0].p.data[e])) : (m.jqGrid("expandRow", m[0].p.data[e]),
                                  m.jqGrid("expandNode", m[0].p.data[e]))),
                              !1
                        }),
                        d.ExpandColClick === !0 && $(m[0].rows[q].cells[s]).find("span.cell-wrapper").css("cursor", "pointer").on("click", function(a) {
                          var b = a.target || a.srcElement
                              , c = $.jgrid.stripPref(d.idPrefix, $(b, m[0].rows).closest("tr.jqgrow")[0].id)
                              , e = m[0].p._index[c];
                          return m[0].p.data[e][t] || (m[0].p.data[e][u] ? (m.jqGrid("collapseRow", m[0].p.data[e]),
                  ...
                  this.each(function() {
                    if (this.grid) {
                      ...
                      if ("remote" === a.exptype) {
                        ...
                        a.exportgrouping && (c = JSON.stringify(this.p.groupingView),
                        "string" == typeof c && (d.groupingView = c));
            ...
            editRow: function(a, b, c, d, e, f, g, h, i) {
              ...
              return "object" === $.type(k[0]) ? j = k[0] : (void 0 !== b && (j.keys = b),
                  ...
                  this.each(function() {
                    ...
                    if (h.grid && (e = $(h).jqGrid("getInd", a, !0),
                        e !== !1)) {
                      if (h.p.beforeAction = !0,
                              g = $.isFunction(j.beforeEditRow) ? j.beforeEditRow.call(h, j, a) : void 0,
                          void 0 === g && (g = !0),
                              !g)
                        return void (h.p.beforeAction = !1);
                      d = $(e).attr("editable") || "0",
                      ...
                      j.keys === !0 && $(e).on(j.keyevent, function(b) {
                        if (27 === b.keyCode) {
            ...
            saveRow: function(a, b, c, d, e, f, g) {
              ...
              if (void 0 === x && (x = !0),
                ...
                if (l = $(o).attr("editable"),
                  ...
                  var E, F = j.p.prmNames, G = a;
                  if (E = j.p.keyName === !1 ? F.id : j.p.keyName,
                          q) {
                    if (q[F.oper] = F.editoper,
                        void 0 === q[E] || "" === q[E])
                      q[E] = a;
                    else if (o.id !== j.p.idPrefix + q[E]) {
                      var H = $.jgrid.stripPref(j.p.idPrefix, a);
                      if (void 0 !== j.p._index[H] && (j.p._index[q[E]] = j.p._index[H],
                              delete j.p._index[H]),
                              a = j.p.idPrefix + q[E],
                              $(o).attr("id", a),
                          j.p.selrow === G && (j.p.selrow = a),
                              $.isArray(j.p.selarrrow)) {
                        var I = $.inArray(G, j.p.selarrrow);
                        I >= 0 && (j.p.selarrrow[I] = a)
                      }
                      if (j.p.multiselect) {
                        var J = "jqg_" + j.p.id + "_" + a;
                        $("input.cbox", o).attr("id", J).attr("name", J)
                      }
                    }
                  ...
                  if ("clientArray" === i.url) {
                    ...
                    var K, L = $(j).jqGrid("setRowData", a, q);
                    for ($(o).attr("editable", "0"),
                             K = 0; K < j.p.savedRow.length; K++)
                      if (String(j.p.savedRow[K].id) === String(G)) {
                        m = K;
                        break
                      }
                    m >= 0 && j.p.savedRow.splice(m, 1),
                        $(j).triggerHandler("jqGridInlineAfterSaveRow", [a, L, q, i]),
                    $.isFunction(i.aftersavefunc) && i.aftersavefunc.call(j, a, L, q, i),
                        p = !0,
                    ...
                    $(j).jqGrid("progressBar", {
                      ...
                      htmlcontent: i.savetext
                        ...
                        s = $.extend({}, q, s),
                        s[E] = $.jgrid.stripPref(j.p.idPrefix, s[E]),
                        $.ajax($.extend({
                          url: i.url,
                ...
                saveAfterSelect: !1
                  ...
                  this.each(function() {
                    if (this.grid && !this.p.inlineNav) {
                      ...
                      (b.restoreAfterSelect === !0 || b.saveAfterSelect === !0) && $(c).on("jqGridBeforeSelectRow.inlineNav", function(a, d) {
                        c.p.savedRow.length > 0 && c.p.inlineNav === !0 && d !== c.p.selrow && null !== c.p.selrow && (c.p.selrow === b.addParams.rowID ? $(c).jqGrid("delRowData", c.p.selrow) : b.restoreAfterSelect === !0 ? $(c).jqGrid("restoreRow", c.p.selrow, b.editParams) : $(c).jqGrid("saveRow", c.p.selrow, b.editParams),
                  ...
                  return $.extend({
                    accept: function(a) {
                      if (!$(a).hasClass("jqgrow"))
                        return a;
                      if (g = $(a).closest("table.ui-jqgrid-btable"),
                          g.length > 0 && void 0 !== $.data(g[0], "dnd")) {
                        var b = $.data(g[0], "dnd").connectWith;
                    ...
                    drop: function(b, c) {
                      if ($(c.draggable).hasClass("jqgrow")) {
                        ...
                        if (!a.dropbyname) {
                          var f, h, i = 0, j = {}, k = $("#" + $.jgrid.jqID(this.id)).jqGrid("getGridParam", "colModel");
                          try {
                            for (h in e)
                              e.hasOwnProperty(h) && (f = k[i].name,
                              "cb" !== f && "rn" !== f && "subgrid" !== f && e.hasOwnProperty(h) && k[i] && (j[f] = e[h]),
                                  i++);
                            e = j
                          } catch (l) {}
                        }
                        if (c.helper.dropped = !0,
                            $.data(g[0], "dnd").beforedrop && $.isFunction($.data(g[0], "dnd").beforedrop)) {
                          var m = $.data(g[0], "dnd").beforedrop.call(this, b, c, e, $(g[0]), $(this));
                          void 0 !== m && null !== m && "object" == typeof m && (e = m)
                        }
                        if (c.helper.dropped) {
                          var n;
                          a.autoid && ($.isFunction(a.autoid) ? n = a.autoid.call(this, e) : (n = Math.ceil(1e3 * Math.random()),
                                  n = a.autoidprefix + n)),
                              $("#" + $.jgrid.jqID(this.id)).jqGrid("addRowData", n, e, a.droppos)
                        }
          ...
          return this.each(function() {
              ...
              for (e in a)
                if (a.hasOwnProperty(e)) {
                  if ("object" != typeof a[e]) {
                    if ("level" === e) {
                      if (void 0 === K[a.level] && (K[a.level] = "",
                          a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (i[a.level - 1] = {
                            useColSpanStyle: !1,
                            groupHeaders: []
                          })),
                          K[a.level] !== a.text && a.children.length && -1 === a.text.indexOf("_r_Totals") && a.level > 0) {
                  ...
                  if (null != a[e] && "object" == typeof a[e] && n(a[e]),
                      "level" === e && a.level > 0 && (a.level === (0 === s ? a.level : s) || -1 !== K[a.level].indexOf("_r_Totals"))) {
                    d = 0;
                    for (b in a.fields)
            ...
            for (var A = r - 1, B = {}, C = []; w > x; ) {
              ...
              u = {},
                  q = 0;
              do
                D[q] = $.trim(o[j.xDimension[q].dataName]),
                    u[j.xDimension[q].dataName] = D[q],
                    q++;
              while (r > q);var F = 0;
              if (p = -1,
                      v = b(d, k, D)) {
                if (p >= 0) {
                  if (F = 0,
                      s >= 1) {
                    for (F = 0; s > F; F++)
                      E[F] = $.trim(o[j.yDimension[F].dataName]),
                      j.yDimension[F].converter && $.isFunction(j.yDimension[F].converter) && (E[F] = j.yDimension[F].converter.call(this, E[F], D, E));
                    v = m(o, j.aggregates, E, v)
                  } else
            ...
            if (j.colTotals)
              for (var O = d.length; O--; )
                for (q = r; q < c.length; q++)
                  N = c[q].name,
                      e[N] ? e[N] += parseFloat(d[O][N] || 0) : e[N] = parseFloat(d[O][N] || 0);
            if (A > 0)
              for (q = 0; A > q; q++)
            ...
            if (c.grid) {
              ...
              for (void 0 !== b && b > 0 && (r = b,
                ...
                if ($(c.rows[r]).hasClass("jqgrow")) {
                  if (c.p.scroll && $(c.rows[r].cells[a]).off("click"),
                          p = null,
                          s)
                    var p = c.p.isHasSubGrid.call(c, c.rows[r].id);
                  p === !1 ? c.rows[r].cells[a].innerHTML = "" : $(c.rows[r].cells[a]).on("click", function() {
          ...
          return this.each(function() {
            ...
            if (c.grid && c.p.treeGrid) {
              ...
              for ($(c).triggerHandler("jqGridBeforeSetTreeNode", [s, b]),
                   $.isFunction(c.p.beforeSetTreeNode) && c.p.beforeSetTreeNode.call(c, s, b); b > a; ) {
                var t, u = $.jgrid.stripPref(c.p.idPrefix, c.rows[a].id), v = c.p._index[u];
                j = c.p.data[v],
                ...
                f !== parseInt(c.p.tree_root_level, 10) && (t = $(c).jqGrid("isVisibleNode", j),
                t || $(c.rows[a]).css("display", "none")),
                ...
                c.p.ExpandColClick === !0 && $(c.rows[a].cells[l]).find("span.cell-wrapper").css("cursor", "pointer").on("click", function(a) {
                  var b = a.target || a.srcElement
                      , d = $.jgrid.stripPref(c.p.idPrefix, $(b, c.rows).closest("tr.jqgrow")[0].id)
                      , e = c.p._index[d];
                  return c.p.data[e][n] || (c.p.data[e][m] ? ($(c).jqGrid("collapseRow", c.p.data[e]),
              ...
              switch (d.p.treeGridModel) {
                case "nested":
                  var h = d.p.treeReader.left_field
                      ...
                      , m = parseInt(a[j], 10);
                  for (e = 0; g > e; e++)
                    f = b ? d.p.data[d.p._index[this.rows[e].id]] : d.p.data[e],
                ...
                case "adjacency":
                  ...
                  for (e = 0; g > e; e++)
                    f = b ? d.p.data[d.p._index[this.rows[e].id]] : d.p.data[e],
                    f && String(f[n]) === String($.jgrid.stripPref(d.p.idPrefix, a[o])) && c.push(f)
              }
            }
          }),
              c
        ...
        setLeaf: function(a, b, c) {
          return this.each(function() {
            ...
            if (b === !0)
              ...
              c && (i = this.p.treeIcons.plus + " tree-plus"),
                  $("div.treeclick", e).removeClass(this.p.treeIcons.leaf + " tree-leaf").addClass(i)
            }
          })
        },
    ...
    return a = $.extend({
      connectWith: !1
        ...
        this.each(function() {
          ...
          var d, e, c = $(this).children(a.items), f = $("<" + (/^ul|ol$/i.test(this.tagName) ? "li" : /^tbody$/i.test(this.tagName) ? "tr" : "div") + ' class="sortable-placeholder ' + a.placeholderClass + '">').html("&nbsp;");
      ...
      $.extend($.jgrid, {
        formatCell: function(a, b, c, d, e) {
          ...
          if (void 0 !== d.formatter) {
            ...
            f = $.isFunction(d.formatter) ? d.formatter.call(e, a, g, c) : $.fmatter ? $.fn.fmatter.call(e, d.formatter, a, g, c) : a
          } else
            f = a;
          return f
        },
        ...
        exportToCsv: function(a) {
          ...
          return this.each(function() {
            function c(a, b) {
              ...
              function d(a, d, e, f) {
                var g, h, l = c(a, d, e), m = l.cnt, n = new Array(b.collen), o = 0;
                for (h = f; k > h; h++)
                  if (!j[h].hidden) {
                    var p = "{0}";
                    $.each(l.summary, function() {
                      if (this.nm === j[h].name) {
                        j[h].summaryTpl && (p = j[h].summaryTpl),
              ...
              return o.reverse(),
                  $.each(f.groups, function(c, k) {
                    ...
                    var q = "";
                    q = $.isFunction(f.groupText[k.idx]) ? f.groupText[k.idx].call(i, m, k.cnt, k.summary) : $.jgrid.template(f.groupText[k.idx], m, k.cnt, k.summary),
                    "string" != typeof q && "number" != typeof q && (q = m);
                    var r;
                    r = "header" === f.groupSummaryPos[k.idx] ? d(c, 0, f.groups, 0) : new Array(b.collen),
                        r[0] = $.jgrid.formatCellCsv($.jgrid.stripHtml(q), b),
                        e += r.join(b.separator) + b.newLine;
                    var s = h - 1 === k.idx;
                    if (s) {
                      var t, u, v, w = f.groups[c + 1], x = 0, y = k.startRow, z = void 0 !== w ? w.startRow : f.groups[c].startRow + f.groups[c].cnt;
                      for (t = y; z > t && a[t - x]; t++) {
                        for (v = a[t - x],
                                 n = 0,
                                 u = 0; u < j.length; u++)
                          j[u].hidden || (r[n] = $.jgrid.formatCellCsv($.jgrid.formatCell(v[j[u].name], u, v, j[u], i), b),
                              n++);
                        e += r.join(b.separator) + b.newLine
                      }
                      if ("header" !== f.groupSummaryPos[k.idx]) {
                        var A;
                        if (void 0 !== w) {
                          for (A = 0; A < f.groupField.length && w.dataIndex !== f.groupField[A]; A++)
                            ;
                          l = f.groupField.length - A
                        }
                        for (u = 0; l > u; u++)
                          o[u] && (r = d(c, u, f.groups, 0),
                              e += r.join(b.separator) + b.newLine);
                        l = A
                      }
                    }
            ...
            var d, e, f, g, h, i = this, j = this.addLocalData(!0), k = j.length, l = i.p.colModel, m = l.length, n = 0, o = "", p = "", q = "", r = "", s = "", t = [], u = [], v = {};
            if ($.each(l, function(b, c) {
                  "cb" !== c.name && "rn" !== c.name || c.hidden || (u.push(b),
                      c.hidden = !0),
                  c.hidden || (t.push($.jgrid.formatCellCsv(c.label || c.name, a)),
                      v[c.name] = c.label || c.name)
                }),
                a.includeLabels && (s = t.join(a.separator) + a.newLine),
                    a.collen = t.length,
                    i.p.grouping)
              o += c(j, a);
            else
              for (; k > n; ) {
                for (e = j[n],
                         ...
                         g = 0,
                         d = 0; m > d; d++)
                  l[d].hidden || (f[g] = $.jgrid.formatCellCsv($.jgrid.formatCell(e[l[d].name], d, e, l[d], i), a),
                      g++);
                o += f.join(a.separator) + a.newLine,
                    n++
              }
            if (j = null,
            ...
            if (a.includeGroupHeader && i.p.groupHeader && i.p.groupHeader.length) {
              var w = i.p.groupHeader;
              for (d = 0; d < w.length; d++) {
                var x = w[d].groupHeaders;
                n = 0,
                    f = [];
                for (h in v)
                  if (v.hasOwnProperty(h)) {
                    for (f[n] = "",
                             g = 0; g < x.length; g++)
                      x[g].startColumnName === h && (f[n] = x[g].titleText);
                    n++
                  }
            ...
            if (a.includeFooter && i.p.footerrow) {
              var y = $(".ui-jqgrid-ftable", this.sDiv);
              if (y.length) {
                var z = y[0].rows[0];
                for (d = 0,
                         n = 0,
                         f = []; d < z.cells.length; ) {
                  var A = z.cells[d]
                      , B = $(A).attr("aria-describedby").slice(-3);
                  A.hidden || "_cb" === B || "_rn" === B || (f[n] = $.jgrid.formatCellCsv($(A).text(), a),
                      n++),
                      d++
                }
            ...
            for (b = p + q + s + o + r,
              ...
              a.returnAsString ? b : void jqGridUtils.saveAs(b, a.fileName, {
                    type: a.mimetype
                  })
        },
            ...
            onBeforeExport: null
              ...
              this.each(function() {
                function b(a) {
                  ...
                  function c(a, c, f, g) {
                    var h, j, l = b(a, c, f), m = l.cnt, o = d(n.header[0]);
                    for (j = g; i > j; j++)
                      if (!k[j].hidden) {
                        var p = "{0}";
                        $.each(l.summary, function() {
                          if (this.nm === k[j].name) {
                            k[j].summaryTpl && (p = k[j].summaryTpl),
                            "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd : this.v && m > 0 && (this.v = this.v / m));
                            try {
                              this.groupCount = l.cnt,
                                  this.groupIndex = l.dataIndex,
                                  this.groupValue = l.value,
                                  h = e.formatter("", this.v, j, this)
                            } catch (a) {
                              h = this.v
                            }
                  ...
                  var l, m = $.makeArray(f.groupSummary);
                  m.reverse(),
                      $.each(f.groups, function(b, i) {
                        j++;
                        try {
                          l = $.isArray(f.formatDisplayField) && $.isFunction(f.formatDisplayField[i.idx]) ? f.formatDisplayField[i.idx].call(e, i.displayValue, i.value, e.p.colModel[g[i.idx]], i.idx, f) : e.formatter("", i.displayValue, g[i.idx], i.value)
                        } catch (k) {
                          l = i.displayValue
                        }
                        var o = "";
                        o = $.isFunction(f.groupText[i.idx]) ? f.groupText[i.idx].call(e, l, i.cnt, i.summary) : $.jgrid.template(f.groupText[i.idx], l, i.cnt, i.summary),
                        "string" != typeof o && "number" != typeof o && (o = l);
                        var p;
                        p = "header" === f.groupSummaryPos[i.idx] ? c(b, 0, f.groups, 0) : d(n.header[0]);
                        var r = Object.keys(p);
                        p[r[0]] = $.jgrid.stripHtml(new Array(5 * i.idx).join(" ") + o),
                            q(p, !0);
                        var s = h - 1 === i.idx;
                        if (s) {
                          ...
                          if ("header" !== f.groupSummaryPos[i.idx]) {
                            ...
                            if (void 0 !== v) {
                              for (A = 0; A < f.groupField.length && v.dataIndex !== f.groupField[A]; A++)
                                ;
                              j = f.groupField.length - A
                            }
                            for (u = 0; j > u; u++)
                              m[u] && (p = c(b, u, f.groups, 0),
                                  q(p, !0));
                            j = A
                          }
                        }
                ...
                var c, d, e = this, f = $.jgrid.excelStrings, g = 0, h = $.parseXML(f["xl/worksheets/sheet1.xml"]), i = h.getElementsByTagName("sheetData")[0], j = {
                  _rels: {
                    ".rels": $.parseXML(f["_rels/.rels"])
                  },
                  xl: {
                    _rels: {
                      "workbook.xml.rels": $.parseXML(f["xl/_rels/workbook.xml.rels"])
                    },
                    "workbook.xml": $.parseXML(f["xl/workbook.xml"]),
                    "styles.xml": $.parseXML(f["xl/styles.xml"]),
                    worksheets: {
                      "sheet1.xml": h
                    }
                  },
                  "[Content_Types].xml": $.parseXML(f["[Content_Types].xml"])
                }, k = e.p.colModel, l = 0, m = {}, n = {
                  body: e.addLocalData(!0),
                  header: [],
                  footer: [],
                  width: [],
                  map: []
                ...
                for (c = 0,
                         d = k.length; d > c; c++)
                  k[c].hidden || "cb" === k[c].name || "rn" === k[c].name || (m[k[c].name] = k[c].label || k[c].name,
                      n.width[l] = 5,
                      n.map[l] = c,
                      l++);
                n.header.push(m);
                var o, p, q = function(b, c) {
                  o = g + 1,
                      p = $.jgrid.makeNode(h, "row", {
                        attr: {
                          r: o
                        }
                      });
                  var d = 0;
                  for (var f in n.header[0])
                    if (n.header[0].hasOwnProperty(f)) {
                      var j, l = $.jgrid.excelCellPos(d) + "" + o, m = b[f];
                      if (null == m && (m = ""),
                          c || (m = "" !== m ? $.jgrid.formatCell(m, n.map[d], b, k[n.map[d]], e) : m),
                              n.width[d] = Math.max(n.width[d], Math.min(parseInt(m.length, 10), a.maxlength)),
                          "number" == typeof m || m.match && $.trim(m).match(/^-?\d+(\.\d+)?$/) && !$.trim(m).match(/^0\d+/))
                        j = $.jgrid.makeNode(h, "c", {
                          attr: {
                            t: "n",
                            r: l
                          },
                          children: [$.jgrid.makeNode(h, "v", {
                            text: m
                          })]
                        });
                      else {
                        var q = m.replace ? $.jgrid.htmlEncode(m) : m;
                        j = $.jgrid.makeNode(h, "c", {
                          attr: {
                            t: "inlineStr",
                            r: l
                          ...
                          children: {
                            row: $.jgrid.makeNode(h, "is", {
                              children: {
                                row: $.jgrid.makeNode(h, "t", {
                                  text: q
                                })
                              }
                            })
                ...
                if ($("sheets sheet", j.xl["workbook.xml"]).attr("name", a.sheetName),
                    a.includeGroupHeader && e.p.groupHeader && e.p.groupHeader.length) {
                  var r = e.p.groupHeader
                      , s = []
                      , t = 0;
                  for (l = 0; l < r.length; l++) {
                    var u = r[l].groupHeaders
                        , v = {};
                    c = 0,
                        t++;
                    for (var w in n.header[0])
                      if (n.header[0].hasOwnProperty(w)) {
                        v[w] = "";
                        for (var x = 0; x < u.length; x++)
                          if (u[x].startColumnName === w) {
                            v[w] = u[x].titleText;
                            var y = $.jgrid.excelCellPos(c) + t
                                , z = $.jgrid.excelCellPos(c + u[x].numberOfColumns - 1) + t;
                            s.push({
                              ref: y + ":" + z
                            })
                          }
                  ...
                  var A = $.jgrid.makeNode(h, "mergeCells", {
                    attr: {
                      count: s.length
                    }
                  });
                  for ($("worksheet", h).append(A),
                           l = 0; l < s.length; l++)
                    A.appendChild($.jgrid.makeNode(h, "mergeCell", {
                      attr: s[l]
                    }))
                }
                if (a.includeLabels && (q(n.header[0], !0),
                        $("row c", h).attr("s", "2")),
                        e.p.grouping)
                  b(n.body);
                else
                  for (var B = 0, C = n.body.length; C > B; B++)
                    q(n.body[B], !1);
                if (a.includeFooter || e.p.footerrow) {
                  n.footer = $(e).jqGrid("footerData", "get");
                  for (l in n.footer)
                    n.footer.hasOwnProperty(l) && (n.footer[l] = $.jgrid.stripHtml(n.footer[l]));
                  q(n.footer, !0),
                      $("row:last c", h).attr("s", "2")
                }
                var D = $.jgrid.makeNode(h, "cols");
                for ($("worksheet", h).prepend(D),
                         l = 0,
                         d = n.width.length; d > l; l++)
                  D.appendChild($.jgrid.makeNode(h, "col", {
                    attr: {
                      min: l + 1,
                      max: l + 1,
                      width: n.width[l],
                ...
                $.isFunction(a.onBeforeExport) && a.onBeforeExport(j),
                    n = null;
                try {
                  var E = new JSZip
                      , F = {
                  ...
                  $.jgrid.xmlToZip(E, j),
                      E.generateAsync ? E.generateAsync(F).then(function(b) {
                            jqGridUtils.saveAs(b, a.fileName, {
                              type: a.mimetype
                            })
                          }) : jqGridUtils.saveAs(E.generate(F), a.fileName, {
                            type: a.mimetype
                          })
                } catch (G) {
                  throw G
          ...
          return a = $.extend(!0, {
            ...
            mimetype: "application/pdf"
              ...
              this.each(function() {
                function b(a) {
                  function b(a, b) {
                    var c = 0
                        , d = [];
                    for (var e in l)
                      l.hasOwnProperty(e) && (j = {
                        text: null == a[e] ? "" : b ? $.jgrid.formatCell(a[e] + "", n[c], k[m], p[n[c]], g) : a[e],
                        alignment: q[e],
                        style: "tableBody"
                      },
                          d.push(j),
                  ...
                  u.reverse(),
                      $.each(f.groups, function(c, j) {
                        ...
                        var m = "";
                        m = $.isFunction(f.groupText[j.idx]) ? f.groupText[j.idx].call(g, t, j.cnt, j.summary) : $.jgrid.template(f.groupText[j.idx], t, j.cnt, j.summary),
                        "string" != typeof m && "number" != typeof m && (m = t);
                        var n;
                        n = "header" === f.groupSummaryPos[j.idx] ? d(c, 0, f.groups, 0) : e(l);
                        var p = Object.keys(n);
                        n[p[0]] = $.jgrid.stripHtml(new Array(5 * j.idx).join(" ") + m),
                            h.push(b(n, !1));
                        var q = o - 1 === j.idx;
                        if (q) {
                          var r, v, w = f.groups[c + 1], x = 0, y = j.startRow, z = void 0 !== w ? w.startRow : f.groups[c].startRow + f.groups[c].cnt;
                          for (r = y; z > r && a[r - x]; r++) {
                            var A = a[r - x];
                            h.push(b(A, !0))
                          }
                          if ("header" !== f.groupSummaryPos[j.idx]) {
                            var B;
                            if (void 0 !== w) {
                              for (B = 0; B < f.groupField.length && w.dataIndex !== f.groupField[B]; B++)
                                ;
                              s = f.groupField.length - B
                            }
                            for (v = 0; s > v; v++)
                              u[v] && (n = d(c, v, f.groups, 0),
                                  h.push(b(n, !1)));
                            s = B
                          }
                        }
                ...
                for (c = 0,
                         d = i.length; d > c; c++)
                  i[c].hidden || "cb" === i[c].name || "rn" === i[c].name || (j = {
                    text: i[c].label || i[c].name,
                    style: "tableHeader"
                  },
                      o.push(j),
                      l[i[c].name] = i[c].label || i[c].name,
                      n[m] = c,
                      p.push(i[c].width),
                ...
                if (a.includeLabels && h.push(o),
                  ...
                  for (m = 0,
                    ...
                    for (e in l)
                      l.hasOwnProperty(e) && (j = {
                        text: null == u[e] ? "" : $.jgrid.formatCell(u[e] + "", n[f], k[m], i[n[f]], g),
                        alignment: q[e],
                        style: "tableBody"
                      },
                          o.push(j),
                ...
                a.customSettings && a.customSettings.call(g, w);
                try {
