    ...
    return this.each(function() {
      ...
      $table.on("click", "th", function() {
        ...
        setTimeout(function() {
          ...
          var reverse_column = !!$this.data("sort-dir") && !$this.data("sort-desc") && !$this.data("sort-reset");
          ...
          if($this.data("sort-reset") && sort_dir == dir.DESC) sortedTRs = $(sortedTRs).get().reverse();
